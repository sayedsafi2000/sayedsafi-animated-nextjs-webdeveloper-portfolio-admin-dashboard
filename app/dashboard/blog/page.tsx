              ...
              <div className="p-4 sm:p-6">
                ...
                <div className="flex flex-wrap items-center gap-2 pt-4 border-t border-gray-200 dark:border-gray-700">
                  <motion.button
                    ...
                    className="px-3 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white hover:from-blue-600 hover:to-cyan-600 transition-all text-xs sm:text-sm font-semibold rounded-lg shadow-md"
                  ...
                  <motion.button
                    ...
                    className="px-3 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:from-purple-600 hover:to-pink-600 transition-all text-xs sm:text-sm font-semibold rounded-lg shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    Edit
                  ...
                  <motion.button
                    ...
                    className={`px-3 py-1.5 sm:px-4 sm:py-2 transition-all text-xs sm:text-sm font-semibold rounded-lg ${
                      blog.published
                  ...
                  <motion.button
                    ...
                    className="px-3 py-1.5 sm:px-4 sm:py-2 bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 hover:bg-red-200 dark:hover:bg-red-900/50 transition-all text-xs sm:text-sm font-semibold rounded-lg"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    Delete
